...
class Ui_sad(object):
    def play(self, Young, Song, Know, Rise, Dark, Therapy, Forward, Dive):
        global player

        if Young:
            import vlc
            path_on_cloud = "Young Dumb & Broke" + ".mp3"
            ...
            import vlc
            path_on_cloud = "I Don't Know Why" + ".mp3"
            links = storage.child(path_on_cloud).get_url(None)
            player = vlc.MediaPlayer(links)
            player.play()
            ...
            import vlc
            path_on_cloud = "Dancing in the Dark" + ".mp3"
            links = storage.child(path_on_cloud).get_url(None)
            player = vlc.MediaPlayer(links)
            player.play()
    ...
    def setupUi(self, MainWindow):
        ...
        self.radioButton_5.setGeometry(QtCore.QRect(230, 330, 361, 21))
        font = QtGui.QFont()
        font.setFamily("Arial Rounded MT Bold")
        font.setPointSize(9)
        ...
        self.radioButton_12.setGeometry(QtCore.QRect(230, 120, 361, 21))
        font = QtGui.QFont()
        font.setFamily("Arial Rounded MT Bold")
        font.setPointSize(9)
        ...
        self.pushButton_4.setGeometry(QtCore.QRect(380, 500, 61, 51))
        self.pushButton_4.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.pushButton_4.setText("")
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("../../play.jpeg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_4.setIcon(icon6)
        self.pushButton_4.setIconSize(QtCore.QSize(50, 50))
        self.pushButton_4.setObjectName("pushButton_4")
        self.radioButton_4 = QtWidgets.QRadioButton(self.centralwidget)
        self.radioButton_4.setGeometry(QtCore.QRect(230, 300, 361, 21))
        font = QtGui.QFont()
        font.setFamily("Arial Rounded MT Bold")
        font.setPointSize(9)
        ...
        self.pushButton_7.setGeometry(QtCore.QRect(470, 500, 61, 51))
        ...
        self.radioButton_10.setGeometry(QtCore.QRect(230, 180, 361, 21))
        font = QtGui.QFont()
        font.setFamily("Arial Rounded MT Bold")
        font.setPointSize(9)
        ...
        self.pushButton_14.setGeometry(QtCore.QRect(400, 10, 101, 91))
        font = QtGui.QFont()
        font.setFamily("Arial Rounded MT Bold")
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("../../sad.jpeg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_14.setIcon(icon8)
        self.pushButton_14.setIconSize(QtCore.QSize(150, 60))
        self.pushButton_14.setObjectName("pushButton_14")
        self.radioButton = QtWidgets.QRadioButton(self.centralwidget)
        self.radioButton.setGeometry(QtCore.QRect(230, 210, 361, 21))
        font = QtGui.QFont()
        font.setFamily("Arial Rounded MT Bold")
        font.setPointSize(9)
        ...
        self.label_2.setGeometry(QtCore.QRect(180, 110, 591, 371))
        self.label_2.setStyleSheet("background-color: rgb(43, 86, 129);\n"
"background-color: rgb(255, 255, 255);")
        self.label_2.setText("")
        self.label_2.setObjectName("label_2")
        self.radioButton_3 = QtWidgets.QRadioButton(self.centralwidget)
        self.radioButton_3.setGeometry(QtCore.QRect(230, 270, 361, 21))
        font = QtGui.QFont()
        font.setFamily("Arial Rounded MT Bold")
        font.setPointSize(9)
        ...
        self.radioButton_11.setGeometry(QtCore.QRect(230, 150, 361, 21))
        font = QtGui.QFont()
        font.setFamily("Arial Rounded MT Bold")
        font.setPointSize(9)
        ...
        self.radioButton_2.setGeometry(QtCore.QRect(230, 240, 361, 21))
        font = QtGui.QFont()
        font.setFamily("Arial Rounded MT Bold")
        font.setPointSize(9)
        ...
        self.pushButton_9.setGeometry(QtCore.QRect(570, 500, 61, 51))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.radioButton.setText(_translate("MainWindow", "  Young Dumb & Broke"))
        self.radioButton_2.setText(_translate("MainWindow", "  Our song"))
        self.radioButton_3.setText(_translate("MainWindow", "  I Don\'t Know Why"))
        self.radioButton_4.setText(_translate("MainWindow", "  Rise Up"))
        self.radioButton_5.setText(_translate("MainWindow", "  Dancing In The Dark"))
        self.radioButton_10.setText(_translate("MainWindow", "  Therapy"))
        self.radioButton_11.setText(_translate("MainWindow", "  Forward"))
        self.radioButton_12.setText(_translate("MainWindow", "  Dive"))
