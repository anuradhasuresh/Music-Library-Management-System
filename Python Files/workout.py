...
class Ui_workout(object):
    def play(self, Holdup, Rockstar, Believer, Fire, Bad, Thank, Shape, Magic):
        global player
        ...
        if Holdup:
            ...
            import vlc
            path_on_cloud = "thank u, next" + ".mp3"
            links = storage.child(path_on_cloud).get_url(None)
            player = vlc.MediaPlayer(links)
            player.play()
    ...
    def setupUi(self, MainWindow):
        ...
        self.pushButton_4.setGeometry(QtCore.QRect(330, 521, 61, 51))
        self.pushButton_4.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.pushButton_4.setText("")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../../play.jpeg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_4.setIcon(icon)
        self.pushButton_4.setIconSize(QtCore.QSize(50, 50))
        self.pushButton_4.setObjectName("pushButton_4")
        self.pushButton_14 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_14.setGeometry(QtCore.QRect(420, 31, 101, 91))
        font = QtGui.QFont()
        font.setFamily("Arial Rounded MT Bold")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("../../workout.jpeg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("../../yourplaylist.jpeg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.pushButton_7.setGeometry(QtCore.QRect(430, 521, 61, 51))
        self.pushButton_7.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.pushButton_7.setText("")
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("../../pause.jpeg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.pushButton_9.setGeometry(QtCore.QRect(540, 521, 61, 51))
        self.pushButton_9.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.pushButton_9.setText("")
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("../../stop.jpeg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("../../home.jpeg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("../../upload.jpeg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.radioButton_7.setGeometry(QtCore.QRect(238, 290, 361, 21))
        font = QtGui.QFont()
        font.setFamily("Arial Rounded MT Bold")
        font.setPointSize(9)
...
"background-color: rgb(255, 255, 255);")
        ...
        self.label_4.setGeometry(QtCore.QRect(0, 210, 151, 61))
        font = QtGui.QFont()
        font.setFamily("Arial Rounded MT Bold")
        font.setPointSize(12)
        self.label_4.setFont(font)
        self.label_4.setStyleSheet("background-color: rgb(216, 216, 216);")
        self.label_4.setPixmap(QtGui.QPixmap("../../library.jpeg"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.radioButton.setText(_translate("MainWindow", "  Hold Up"))
        self.radioButton_2.setText(_translate("MainWindow", "  Rockstar"))
        self.radioButton_4.setText(_translate("MainWindow", "  Believer"))
        self.radioButton_5.setText(_translate("MainWindow", "  On Fire"))
        self.radioButton_7.setText(_translate("MainWindow", "  Bad Idea"))
        self.radioButton_10.setText(_translate("MainWindow", "  Thank u, next"))
        self.radioButton_11.setText(_translate("MainWindow", "  Shape Of You"))
        self.radioButton_12.setText(_translate("MainWindow", "  24K Magic"))
